...
st.set_page_config(page_title="Airbnb | Holiday rentals, cabins, beach houses & more", page_icon=r"C:\Users\Javid Akthar\Desktop\Airbnb\Airbnb.jpg",layout='wide')

# Set background image URL (you can replace this with your image URL)
background_image_url = "https://wallpapercave.com/wp/wp10784396.jpg"  
...
st.markdown(f"""
    <style>
        ...
        .stTabs > div > div > div > button:hover {{
            background-color: #FF3B3F !important;  /* Darker red for hover effect */
        }}

        /* The selected tab (active tab) */
        .stTabs > div > div > div > button[aria-selected="true"] {{
            background-color: #FF5A5F !important;  /* Active tab background (Airbnb red) */
...
with col1:
    st.image(r"C:\Users\Javid Akthar\Desktop\Airbnb\1707662825airbnb-logo-white.png", width=300)
with col2:
...
selected = option_menu(
    ...
    styles={
        "nav-link-selected": {
            "background-color": "#FF5A5F",  # Highlighted option with Airbnb red
...
def datafr():
    df= pd.read_csv("C:/Users/Javid Akthar/Desktop/Airbnb/Airbnb.csv")
    return df
...
if selected == "Home":
    ...
    with col1:
        ...
        image2= Image.open(r"C:\Users\Javid Akthar\Desktop\Airbnb\roberto-nickson-Airbnb.jpg")
        st.image(image2,width=650)
        image1= Image.open(r"C:\Users\Javid Akthar\Desktop\Airbnb\airbnb (1).jpg")
...
if selected == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/Javid Akthar/Desktop/Airbnb/Airbnb.csv")
            return df_a
...
if selected == "About":
    ...
    with col1:
        image1= Image.open(r"C:\Users\Javid Akthar\Desktop\Airbnb\AirBnb-5-1024x684.webp")
        st.image(image1)   
    with col2:
